...
import 'package:movieplex/models/seats_model.dart';
import 'package:movieplex/widgets/seat_status.dart';
                            ...
                            child: Column(
                              children: [
                                Text(
                                  ...
                                  style:
                                      font.copyWith(fontSize: 14, color: white),
                                ),
                              ...
                              children: [
                                Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      'Rs.${(selectedSeats.length * 43.5).toStringAsFixed(2)}',
                                      style: font.copyWith(
                                          color: white,
                                          fontSize: 20,
                                          fontWeight: FontWeight.bold),
